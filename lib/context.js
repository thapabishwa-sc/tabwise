...
export function extractFeatures(tab) {
  ...
  // Page content, when reading it is switched on. Ordered by how deliberate
  // each part is (og:title, description, headings, then body), so truncating
  // keeps the most descriptive words.
