...
const DEFAULTS = {
  ...
  // When the AI groups, bias toward the PROJECT/TASK a tab supports rather than
  // its generic topic (e.g. tabs for one work-stream share a label). On by
  // default. Note: this only affects AI-grouped (plain) hosts — internal hosts
  // with a meaningful subdomain still group deterministically (subdomainStrategy).
  aiProjectMode: true,
